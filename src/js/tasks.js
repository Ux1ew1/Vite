    ...
    <div class="details-flex">
      ...
      <div class="details-information">
        <div class="information-descrption">
          ...
          <div class="tasks-text-wrapper">
            <h3 class="tasks-title">Price:</h3>
            <p class="tasks-item">$${cardInfo?.price}</p>
          </div>
          <div class="tasks-text-wrapper">
            <h3 class="tasks-title">Category:</h3>
            <p class="tasks-item">${cardInfo?.category}</p>
          </div>
      </div>
    </div>
  `;
